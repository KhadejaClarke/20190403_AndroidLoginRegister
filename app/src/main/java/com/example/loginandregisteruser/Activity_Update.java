...
public class Activity_Update extends Activity {
    ...
    SQLiteHandler db;
    User user;
    private static final String TAG = Activity_Update.class.getSimpleName();
    ...
    private void initUser() {
        ...
        user = new User(name, email, uid, created_at);
    }
    ...
    private void handleButtonClicks() {
        ...
        cancel.setOnClickListener(v -> new AlertDialog.Builder(Activity_Update.this)
                .setTitle("Logout Confirmation")
                .setMessage("Are you sure you want to logout?")
                .setPositiveButton(android.R.string.yes, (dialog, which) -> startActivity(new Intent(Activity_Update.this, Activity_Main.class)))
                ...
                response -> {
                    try {
                        ...
                        if (!error) {
                            ...
                            Intent intent = new Intent(Activity_Update.this, Activity_Main.class);
